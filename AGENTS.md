...
- [x] US-003: ternary_mac.v adapted (DATA_WIDTH=12, no ILA), tb_ternary_mac passes
- [x] US-004: ternary_poly_mul.v implements 16 MACs + Barrett, tb_ternary_poly_mul passes DEPTH=4 and DEPTH=256
- [x] US-005: PicoRV32 + UART + accelerator integrated, tb_top passes
- [x] US-006: Gowin project file (.gprj) + TCL script created; all iverilog tests pass. Open in Gowin IDE or run gw_sh synth.tcl to synthesise.
